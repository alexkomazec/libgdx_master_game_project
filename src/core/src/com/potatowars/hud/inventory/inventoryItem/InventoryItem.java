package com.potatowars.hud.inventory.inventoryItem;
...
public class InventoryItem extends Image {
    ...
    public InventoryItem(InventoryItem inventoryItem){
        super(Utility.ITEMS_TEXTUREATLAS.findRegion("ARMOR01"));
    ...
    public InventoryItem(InventoryItemJSON inventoryItemJSON){
        super();
        this.itemTypeID             = inventoryItemJSON.itemTypeID;
        this.itemAttributes         = inventoryItemJSON.itemAttributes;
        this.itemUseType            = inventoryItemJSON.itemUseType;
        this.itemUseTypeValue       = inventoryItemJSON.itemUseTypeValue;
        this.itemShortDescription   = inventoryItemJSON.itemShortDescription;
        this.itemValue              = inventoryItemJSON.itemValue;
    }
